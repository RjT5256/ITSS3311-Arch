...
public class Robert_Tulmen_Project1 {
	...
	public static void main(String args[]) {
		...
		/*
		 *Implement a Java program that simulates the presentation and evaluation 
		 *of a flash card in addition or subtraction with factors 
		 *between 0 and 9 inclusive 
		 *User selects the operation, either Addition or Subtraction.
		 *System generates random factors and presents the problem on the screen.
		 *The user enters a response to the problem.
		 *System evaluates the response and indicates whether it is correct or incorrect.  
